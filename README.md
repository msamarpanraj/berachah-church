...
- [User Experience](#user-experience)
  ...
  - [About us Page](#about-us-page)
    ...
    - [Doctrinal Statements](#doctrinal-statements)
  ...
  - [HTML](#html)
    ...
    - [Contact-us.html](#contact-ushtml)
    - [Thank you.html](#thank-youhtml)
    - [404.html](#404html)
  - [CSS](#css)
  - [Manual testing](#manual-testing)
      - [Responsiveness of features tested using Chrome DevTools](#responsiveness-of-features-tested-using-chrome-devtools)
...
- Monochromatic color palette with just black(#000) and white(#fff) color combination is chosen along with a gold shade color to highlight some parts of the text on the website.
...
- The footer has 3 sections, the first section contains small about us section and social media icons.
- The second section contains the icons with address, phone number and email for making easy for visitors to contact us.
- The thirds section of the footer consists of the list of pages which makes easily accessible from header and footer as well.
- Beneath the three part section footer there is a small copyright text.

### Favicon

![Favicon Screenshot](docs/readme-images/screenshot-favicon.jpg)

- A site wide favicon is setup in the head section which shows in almost all browsers.
- It is just the letter B which is generated by favicon.io

## Landing Content

![Landing content Screenshot](docs/readme-images/screenshot-landing-content.jpg)

- The landing content is a large image and large text over it.
- The picture highlights the design as well as highly relavant to the church.
- Right under the image, theres another section with a welcome text.
- The short text welcomes the users and contains about the church.
- This section also contains a CTA, the button(about us) takes to about page.
-

### About Pastor

![About Pastor](docs/readme-images/screenshot-our-pastor.jpg)

- This section introduces the church pastor.
- This mobile responsive layout features image and small content.
- The image was already round cropped using round cropping online tool.
- On smaller devices, the row layout shifts to column for mobile responsiveness.
- A light gold color background used for this section.

### Join us

![Join us section](docs/readme-images/screenshot-service-timings.jpg)

- This section contains small heading and text.
- This section contains grid style layout divided in to 3 boxes, Sunday workhip timings, Watch online, Other church programs schedule and timings.
- The Watch online box within this section contains a CTA button Watch Live which takes to the youtube channel in a seperate tab.
- The row of boxes becomes stacked on smalled devices to maximise available screenspace.
- For each box, light box shadow is used to highlight the look.

## About us Page

![About us page top section](docs/readme-images/screenshot-about-page-top.jpg)

- The about us page provides the user with more detail about the berachah goodnews baptist church, the founders and the doctrinal statements.
- The top of this page contains short heading and short text which containts the page title.
- Under this contains the short text about the church.

### Our Founders

![Our Founders 1](docs/readme-images/screenshot-our-founders.jpg)
![Our Founders 1](docs/readme-images/screenshot-our-founders-2.jpg)

- This section features information about the founders of the church.
- Light gold gold is used as backgorund for this section.
- Founder name is highlighted in gold color and italic style.

### Doctrinal Statements

![Our Founders 1](docs/readme-images/screenshot-doctrinal-statements.jpg)

- This section features the doctrinal statements of the church.
- It contains the information about what this church believes.
- Visitors are expected to see this information on any church website hence it is clearly featured in the about us page.

## Gallery Page

![Gallery Page top](docs/readme-images/screenshot-gallery-top.jpg)
![Gallery](docs/readme-images/screenshot-gallery.jpg)

- The Top of the gallery page features a short heading and small text.
- The gallery page will provide the user with photos of the church and church services. The gallery will be fully responsive on all devices.
- On desktop it is shown as 3 colum layout, on tab it is shown as 2 colum and on mobile it is shown as one colum and only one image displayed in each row.

## Contact us Page

![Contact page top top](docs/readme-images/screenshot-contact-top.jpg)

- The Top of the contact us page features a short heading and small text.
- This page is one of the important page as the visitors make interactions with the website by filling the contact form.
- The form containts the First Name Last Name, Email Address and Message fields.
- All of these are validated for errors.
- The form provides users with error message in case the input is incorrect.
- Once the visitor submits the form successfully ,he will be redirected to the thank you page.
- The contact information like the address, phone number and the email address featured again on this page to make it easy for the visitors to contact in different mediums.

### Contact Icons

![contact icons](docs/readme-images/screenshot-contact-page-icons.jpg)

- The section features 3 boxes with small icons, Address, Phone and Email boxes.
- Address box contains small icon and address of the church
- Phone box containts the phone icon and contact number of the church and it is clickable.
- Email box contains the email icon and email address of the church and it is clickable.
- The layout is shown as row direction on desktop and column direction in mobile and fully mobile resonsive.

### Google Map

![Google Maps](docs/readme-images/screenshot-contact-page-map.jpg)

- This section contains the goole maps which is embedded as iframe.
- This is highly mobile reoponsive.
- The map is clickable and takes to the church google maps page.

## Thank you page

![Thank you page](docs/readme-images/screenshot-thank-you-page.jpg)

- This page will be shown to visitors once they will the contact form.
- It contains small heading and text.

## 404 page

![404 page](docs/readme-images/screenshot-404-page.jpg)

- This page is visible to the visitors when they enter incorrect url ot if a page does not exist on the website.
- This page contains a small heading and text.
- It features a CTA button back to home which takes to the home page when clicked.
...
- [Round Corner](https://round-corner.imageonline.co/)

## Testing

### Accessibility

[Wave Accessibility](https://wave.webaim.org/) tool was very helpful during the developemnt of the website. I was able check for any aid accessibility testing and fix the issues it showed.
